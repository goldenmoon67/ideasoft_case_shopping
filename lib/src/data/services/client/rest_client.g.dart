...
class _RestClient implements RestClient {
  ...
  Future<List<Slider>> getSliders() async {
    ...
    final _options = _setStreamType<List<Slider>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<Slider> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => Slider.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<List<ProductListResponse>> getProducts() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProductListResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<ProductListResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              ProductListResponse.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<ProductListResponse> deleteProduct(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<ReturnIdModel> createProduct(AddProductRequest request) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<ReturnIdModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ReturnIdModel _value;
    try {
      _value = ReturnIdModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> uploadPhoto(CreateImageModel request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
